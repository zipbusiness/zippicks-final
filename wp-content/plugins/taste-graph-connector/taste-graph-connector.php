<?php
/**
 * Plugin Name: Taste Graph Connector
 ...
 * Version: 1.0.0
 * Author: ZipBusiness
 * Author URI: https://zipbusiness.com/
 * License: GPL v2 or later
 * Text Domain: taste-graph-connector
...
class TasteGraphConnector {
    ...
    public function init() {
        ...
        load_plugin_textdomain('taste-graph-connector', false, dirname(plugin_basename(__FILE__)) . '/languages');
    ...
    public function enqueue_admin_assets($hook) {
        ...
        if (strpos($hook, 'taste-graph-connector') === false) {
            return;
        }
    ...
    public function add_admin_menu() {
        add_menu_page(
            __('Taste Graph', 'taste-graph-connector'),
            __('Taste Graph', 'taste-graph-connector'),
            'manage_options',
    ...
    public function admin_page() {
        echo '<div class="wrap">';
        echo '<h1>' . __('Taste Graph Connector', 'taste-graph-connector') . '</h1>';
        echo '<p>' . __('Welcome to the Taste Graph Connector plugin.', 'taste-graph-connector') . '</p>';
    ...
    public function add_cron_schedules($schedules) {
        $schedules['tgc_every_minute'] = array(
            'interval' => 60,
            'display' => __('Every Minute', 'taste-graph-connector')
        );
        return $schedules;
    }
