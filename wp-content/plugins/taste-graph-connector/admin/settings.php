...
class TGC_Admin_Settings {
    ...
    public static function render_page() {
        ...
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'taste-graph-connector'));
        }
        ...
        <div class="wrap">
            ...
            <?php if (isset($_GET['settings-updated']) && $_GET['settings-updated'] === 'true'): ?>
                <div class="notice notice-success is-dismissible">
                    <p><?php _e('Settings saved successfully!', 'taste-graph-connector'); ?></p>
                </div>
            <?php endif; ?>
            ...
            <form method="post" action="">
                ...
                <div class="tgc-settings-tabs">
                    <h2 class="nav-tab-wrapper">
                        <a href="#general" class="nav-tab nav-tab-active" data-tab="general">
                            <?php _e('General', 'taste-graph-connector'); ?>
                        </a>
                        <a href="#api" class="nav-tab" data-tab="api">
                            <?php _e('API Configuration', 'taste-graph-connector'); ?>
                        </a>
                        <a href="#tracking" class="nav-tab" data-tab="tracking">
                            <?php _e('Tracking', 'taste-graph-connector'); ?>
                        </a>
                        <a href="#redis" class="nav-tab" data-tab="redis">
                            <?php _e('Redis', 'taste-graph-connector'); ?>
                        </a>
                        <a href="#advanced" class="nav-tab" data-tab="advanced">
                            <?php _e('Advanced', 'taste-graph-connector'); ?>
                        </a>
                        <a href="#status" class="nav-tab" data-tab="status">
                            <?php _e('Status', 'taste-graph-connector'); ?>
                        </a>
                    </h2>
                    
                    <!-- General Settings -->
                    <div id="general-settings" class="tab-content active">
                        <h3><?php _e('General Settings', 'taste-graph-connector'); ?></h3>
                        
                        <table class="form-table">
                            <tr>
                                <th scope="row">
                                    <label for="tgc_enabled">
                                        <?php _e('Enable Taste Graph', 'taste-graph-connector'); ?>
                                    </label>
                                </th>
                                <td>
                                    <label>
                                        ...
                                        <?php _e('Enable Taste Graph integration', 'taste-graph-connector'); ?>
                                    </label>
                                    <p class="description">
                                        <?php _e('Master switch to enable or disable all Taste Graph functionality.', 'taste-graph-connector'); ?>
                                    </p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="tgc_tracking_enabled">
                                        <?php _e('Enable Tracking', 'taste-graph-connector'); ?>
                                    </label>
                                </th>
                                <td>
                                    <label>
                                        ...
                                        <?php _e('Enable user interaction tracking', 'taste-graph-connector'); ?>
                                    </label>
                                    <p class="description">
                                        <?php _e('Track user interactions to build taste profiles.', 'taste-graph-connector'); ?>
                                    </p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="tgc_debug_mode">
                                        <?php _e('Debug Mode', 'taste-graph-connector'); ?>
                                    </label>
                                </th>
                                <td>
                                    <label>
                                        ...
                                        <?php _e('Enable debug mode', 'taste-graph-connector'); ?>
                                    </label>
                                    <p class="description">
                                        <?php _e('Log detailed information for troubleshooting.', 'taste-graph-connector'); ?>
                                    </p>
                                </td>
                            </tr>
                        </table>
                    ...
                    <div id="api-settings" class="tab-content">
                        <h3><?php _e('API Configuration', 'taste-graph-connector'); ?></h3>
                        
                        <table class="form-table">
                            <tr>
                                <th scope="row">
                                    <label for="tgc_api_url">
                                        <?php _e('API URL', 'taste-graph-connector'); ?>
                                    </label>
                                </th>
                                <td>
                                    ...
                                    <p>
                                        <button type="button" class="button" id="test-api-connection">
                                            <?php _e('Test Connection', 'taste-graph-connector'); ?>
                                        </button>
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="tgc_api_key">
                                        <?php _e('API Key', 'taste-graph-connector'); ?>
                                    </label>
                                </th>
                                <td>
                                    <input type="password" name="tgc_api_key" id="tgc_api_key" 
                                        ...
                                        class="regular-text" />
                                    <p class="description">
                                        <?php _e('Your ZipBusiness API key for authentication.', 'taste-graph-connector'); ?>
                                    </p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="tgc_jwt_secret">
                                        <?php _e('JWT Secret', 'taste-graph-connector'); ?>
                                    </label>
                                </th>
                                <td>
                                    ...
                                    <button type="button" class="button" id="generate-jwt-secret">
                                        <?php _e('Generate New', 'taste-graph-connector'); ?>
                                    </button>
                                    <p class="description">
                                        <?php _e('Shared secret for JWT token generation. Must match the API configuration.', 'taste-graph-connector'); ?>
                                    </p>
                                </td>
                            </tr>
                        </table>
                    ...
                    <div id="tracking-settings" class="tab-content">
                        <h3><?php _e('Tracking Settings', 'taste-graph-connector'); ?></h3>
                        
                        <table class="form-table">
                            <tr>
                                <th scope="row">
                                    <?php _e('Track Interactions', 'taste-graph-connector'); ?>
                                </th>
                                <td>
                                    <fieldset>
                                        <label>
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="tgc_tracking_sample_rate">
                                        <?php _e('Sample Rate', 'taste-graph-connector'); ?>
                                    </label>
                                </th>
                                <td>
                                    ...
                                    <p class="description">
                                        <?php _e('Percentage of users to track (1-100). Use lower values for high-traffic sites.', 'taste-graph-connector'); ?>
                                    </p>
                                </td>
                            </tr>
                        </table>
                    ...
                    <div id="redis-settings" class="tab-content">
                        <h3><?php _e('Redis Configuration', 'taste-graph-connector'); ?></h3>
                        
                        <?php if (!class_exists('Redis')): ?>
                            <div class="notice notice-warning">
                                <p><?php _e('Redis PHP extension is not installed. Redis caching will be disabled.', 'taste-graph-connector'); ?></p>
                            </div>
                        <?php endif; ?>
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="tgc_redis_host">
                                        <?php _e('Redis Host', 'taste-graph-connector'); ?>
                                    </label>
                                </th>
                                <td>
                                    ...
                                    <p class="description">
                                        <?php _e('Redis server hostname or IP address.', 'taste-graph-connector'); ?>
                                    </p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="tgc_redis_port">
                                        <?php _e('Redis Port', 'taste-graph-connector'); ?>
                                    </label>
                                </th>
                                <td>
                                    ...
                                    <p class="description">
                                        <?php _e('Redis server port (default: 6379).', 'taste-graph-connector'); ?>
                                    </p>
                                </td>
                            </tr>
                        </table>
                    ...
                    <div id="advanced-settings" class="tab-content">
                        <h3><?php _e('Advanced Settings', 'taste-graph-connector'); ?></h3>
                        
                        <table class="form-table">
                            <tr>
                                <th scope="row">
                                    <label for="tgc_api_timeout">
                                        <?php _e('API Timeout', 'taste-graph-connector'); ?>
                                    </label>
                                </th>
                                <td>
                                    <input type="number" name="tgc_api_timeout" id="tgc_api_timeout" 
                                        value="<?php echo esc_attr($settings['api_timeout']); ?>" 
                                        min="5" max="60" step="1" class="small-text" /> <?php _e('seconds', 'taste-graph-connector'); ?>
                                    <p class="description">
                                        <?php _e('Maximum time to wait for API responses.', 'taste-graph-connector'); ?>
                                    </p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="tgc_queue_batch_size">
                                        <?php _e('Queue Batch Size', 'taste-graph-connector'); ?>
                                    </label>
                                </th>
                                <td>
                                    ...
                                    <p class="description">
                                        <?php _e('Number of queued items to process per batch.', 'taste-graph-connector'); ?>
                                    </p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th scope="row">
                                    <?php _e('Data Retention', 'taste-graph-connector'); ?>
                                </th>
                                <td>
                                    <label for="tgc_queue_retention_days">
                                        <?php _e('Keep failed queue items for', 'taste-graph-connector'); ?>
                                        ...
                                        <?php _e('days', 'taste-graph-connector'); ?>
                                    </label>
                                    <p class="description">
                                        <?php _e('Automatically clean up old queue items after this many days.', 'taste-graph-connector'); ?>
                                    </p>
                                </td>
                            </tr>
                        </table>
                        
                        <h3><?php _e('Maintenance', 'taste-graph-connector'); ?></h3>
                        
                        <p>
                            <button type="button" class="button" id="clear-cache">
                                <?php _e('Clear Cache', 'taste-graph-connector'); ?>
                            </button>
                            <span class="description">
                                <?php _e('Clear all cached data including JWT tokens and taste profiles.', 'taste-graph-connector'); ?>
                            </span>
                        </p>
                        
                        <p>
                            <button type="button" class="button" id="process-queue">
                                <?php _e('Process Queue Now', 'taste-graph-connector'); ?>
                            </button>
                            <span class="description">
                                <?php _e('Manually process pending queue items.', 'taste-graph-connector'); ?>
                            </span>
                        </p>
                    </div>
                    ...
                    <div id="status-settings" class="tab-content">
                        <h3><?php _e('System Status', 'taste-graph-connector'); ?></h3>
                ...
                <p class="submit">
                    <input type="submit" name="submit" id="submit" class="button button-primary" 
                        value="<?php _e('Save Settings', 'taste-graph-connector'); ?>" />
                </p>
            </form>
        </div>
        ...
        jQuery(document).ready(function($) {
            ...
            $('#generate-jwt-secret').on('click', function() {
                if (!confirm('<?php _e('Generate a new JWT secret? This will invalidate all existing tokens.', 'taste-graph-connector'); ?>')) {
                    return;
                }
            ...
            $('#clear-cache').on('click', function() {
                if (!confirm('<?php _e('Clear all cached data?', 'taste-graph-connector'); ?>')) {
                    return;
                }
    ...
    private static function render_status_page() {
        ...
        <table class="wp-list-table widefat tgc-status-table">
            <tbody>
                <tr>
                    <th><?php _e('API Connection', 'taste-graph-connector'); ?></th>
                    <td>
                        <?php if ($api_healthy): ?>
                            <span class="status-ok">✓ <?php _e('Connected', 'taste-graph-connector'); ?></span>
                        <?php else: ?>
                            <span class="status-error">✗ <?php _e('Not connected', 'taste-graph-connector'); ?></span>
                        <?php endif; ?>
                    </td>
                </tr>
                
                <tr>
                    <th><?php _e('Redis Status', 'taste-graph-connector'); ?></th>
                    <td>
                ...
                <tr>
                    <th><?php _e('Queue Status', 'taste-graph-connector'); ?></th>
                    <td>
                        <?php _e('Pending:', 'taste-graph-connector'); ?> <strong><?php echo intval($queue_stats['total_pending']); ?></strong><br>
                        <?php _e('Failed:', 'taste-graph-connector'); ?> <strong><?php echo intval($queue_stats['database_failed']); ?></strong><br>
                        <?php _e('Completed:', 'taste-graph-connector'); ?> <strong><?php echo intval($queue_stats['database_completed']); ?></strong>
                    </td>
                </tr>
                
                <tr>
                    <th><?php _e('PHP Version', 'taste-graph-connector'); ?></th>
                    <td>
                        <?php echo phpversion(); ?>
                        <?php if (version_compare(phpversion(), '7.4', '<')): ?>
                            <span class="status-error"><?php _e('(Minimum 7.4 required)', 'taste-graph-connector'); ?></span>
                        <?php endif; ?>
                    </td>
                </tr>
                
                <tr>
                    <th><?php _e('WordPress Version', 'taste-graph-connector'); ?></th>
                    <td><?php echo get_bloginfo('version'); ?></td>
                </tr>
                
                <tr>
                    <th><?php _e('Plugin Version', 'taste-graph-connector'); ?></th>
                    <td><?php echo TGC_VERSION; ?></td>
                </tr>
                
                <tr>
                    <th><?php _e('Active Sessions', 'taste-graph-connector'); ?></th>
                    <td>
                        <?php
                        global $wpdb;
